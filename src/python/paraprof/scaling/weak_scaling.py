...
'''
    ...
    def file_contents(self) -> dict:
        return {
            'weak-scaling.sh': self.weak_scaling_str
        }
    
    def plot(self):
        filename = 'weak-scaling.ini'
        assert os.path.exists(filename), 'weak-scaling.ini file does not exist.'
